...
const VEHICLE_FIELDS: { value: string; label: string; required?: boolean }[] = [
  ...
  { value: "condition", label: "Condition (new/used)" },
  { value: "inventory_type", label: "Inventory Type (sale/lease)" },
  { value: "online_price", label: "Online / List Price" },
  { value: "sale_price", label: "Sale Price" },
  { value: "purchase_price", label: "Purchase Price" },
  { value: "msrp", label: "MSRP" },
  { value: "lease_payment", label: "Lease Monthly Payment" },
  { value: "lease_term", label: "Lease Term (months)" },
  { value: "lease_down_payment", label: "Lease Due at Signing" },
  ...
  { value: "image_url", label: "Image URL(s)" },
];
...
const FUZZY_MAP: Record<string, string> = {
  ...
  condition: "condition", "new used": "condition", "newused": "condition", "vehicle condition": "condition",
  ...
  "purchase price": "purchase_price", cost: "purchase_price", invoice: "purchase_price",
  msrp: "msrp", "sticker price": "msrp",
  "lease payment": "lease_payment", "monthly payment": "lease_payment", "lease monthly": "lease_payment",
  "lease term": "lease_term", "term months": "lease_term",
  "lease down": "lease_down_payment", "due at signing": "lease_down_payment", "down payment": "lease_down_payment",
  "annual mileage": "lease_annual_mileage", "lease mileage": "lease_annual_mileage", "mileage allowance": "lease_annual_mileage",
  "broker fee": "broker_fee",
  "taxes and fees": "taxes_and_fees", "tax fees": "taxes_and_fees",
  ...
  image: "image_url", "image url": "image_url", imageurl: "image_url", photo: "image_url",
  "photo url": "image_url", "image link": "image_url", "photo link": "image_url", images: "image_url",
  photos: "image_url", picture: "image_url", "picture url": "image_url",
};
